...
/*    public void PiramidBaseOnShape(GL2 gl2,double size){
        ...
        gl2.glMatrixPushEXT(1);

        gl2.glScaled(size,size,size);
        Polygon(gl2,11);

        gl2.glMatrixPushEXT(1);
        gl2.glTranslated(4.6,0,1.35);
        gl2.glRotated(73.5,0,1,0);
        Triangle(gl2);
        gl2.glMatrixPopEXT(1);

        gl2.glMatrixPushEXT(1);
        gl2.glTranslated(-2.5,0,-0.7);
        gl2.glRotated(-32,0,1,0);
        Triangle(gl2);
        gl2.glMatrixPopEXT(1);

        gl2.glMatrixPushEXT(1);
        gl2.glTranslated(-2.7,0,-0.78);
        gl2.glRotated(-32.5,0,1,0);
        Triangle(gl2);
        gl2.glMatrixPopEXT(1);

        for (int i = 0; i<3;i++){
            gl2.glMatrixPushEXT(1);
            gl2.glTranslated(-2.6,0,-0.85);
            gl2.glRotated(-32.5,0,1,0);
            Triangle(gl2);
            gl2.glMatrixPopEXT(1);
        }
        ...
        gl2.glMatrixPushEXT(1);
        gl2.glTranslated(-2.4,0,-0.8);
        gl2.glRotated(-32,0,1,0);
        Triangle(gl2);
        gl2.glMatrixPopEXT(1);

        gl2.glMatrixPushEXT(1);
        gl2.glTranslated(-2.57,0,-0.8);
        gl2.glRotated(-33.5,0,1,0);
        Triangle(gl2);
        gl2.glMatrixPopEXT(1);

        gl2.glMatrixPushEXT(1);
        gl2.glTranslated(-2.6,0,-0.8);
        gl2.glRotated(-33.5,0,1,0);
        Triangle(gl2);
        gl2.glMatrixPopEXT(1);
